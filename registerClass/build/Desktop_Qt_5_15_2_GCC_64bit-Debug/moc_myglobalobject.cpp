...
QT_MOC_LITERAL(1, 15, 14), // "counterChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 11), // "doSomething"
QT_MOC_LITERAL(4, 43, 4), // "text"
QT_MOC_LITERAL(5, 48, 7) // "counter"

    },
    "MyGlobalObject\0counterChanged\0\0"
    "doSomething\0text\0counter"
};
...
void MyGlobalObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->doSomething((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGlobalObject::counterChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGlobalObject::counterChanged()
{
